...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        useminPrepare: {
            ...
            html: ['<%= yeoman.appClient %>/{,*/}*.html', '<%= yeoman.appClient %>/**/*.jade']
        },
        usemin: {
            options: {
                dirs: ['<%= yeoman.distClient %>'],
                basedir: '<%= yeoman.distClient %>',
            },
            html: ['<%= yeoman.distClient %>/{,*/}*.html', '<%= yeoman.distClient %>/**/*.jade'],
            css: ['<%= yeoman.distClient %>/css/{,*/}*.css']
        },
        imagemin: {
            dist: {
                files: [{
                    expand: true,
                    cwd: '<%= yeoman.appClient %>/img',
                    src: '**/*.{png,jpg,jpeg}',
                    dest: '<%= yeoman.distClient %>/img'
                }]
            }
        },
        svgmin: {
        ...
        simplemocha: {
            ...
            server: {
                src: [
                    ...
                    '<%= yeoman.server %>/config/mochaGlobals.js',
